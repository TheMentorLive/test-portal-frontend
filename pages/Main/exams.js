        ...
        <div className="grid grid-cols-2 gap-2 md:grid-cols-3 lg:grid-cols-12 xl:grid-cols-6">
          {[
            ...
            <div
              key={exam.name}
              onClick={() => openModal(exam)}
              className="flex min-w-[135px] items-center border-opacity-40 border-blue-600 p-2 border rounded-md transition-all duration-300 ease-in-out hover:bg-primary hover:text-primary-foreground cursor-pointer"
            >
              <Image 
                src={exam.icon} 
                alt={exam.name} 
...
>>>>>>> 5e648652bd6d881a31be789bc7e16805beef2713
                  />
                </div>
