...
export default function Dash() {
  ...
  return (
    (<div className="flex flex-col h-screen">
      <header
        className="bg-primary text-primary-foreground py-4 px-6 flex items-center justify-between shadow-md">
      ...
      <div className="flex flex-1">
        <aside
          className="bg-background border-r hidden md:flex flex-col gap-4 py-6 px-4">
          <Link
            href="#"
